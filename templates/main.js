...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initModals() {
        ...
        const registrationModalBody = document.getElementById('registration-modal-body');
        ...
        window.openRegistrationModal = function(type) {
            ...
            if (type === 'influencer') {
                registrationModalBody.innerHTML = `
                    <form id="influencer-registration" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" placeholder="Full Name" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                            <input type="email" placeholder="Email Address" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        </div>
                        <input type="text" placeholder="Social Media Handle" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        <select class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        ...
                        <input type="number" placeholder="Follower Count" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        <select class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        ...
                        <textarea placeholder="Tell us about your content and audience" rows="4" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white resize-none" required></textarea>
                        <button type="submit" class="cta-button w-full py-3 rounded-lg font-semibold text-white">
                            Join Network
                        </button>
                    </form>
                `;
                ...
                registrationModalBody.innerHTML = `
                    <form id="brand-registration" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="text" placeholder="Company Name" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                            <input type="text" placeholder="Contact Person" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <input type="email" placeholder="Email Address" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                            <input type="tel" placeholder="Phone Number" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        </div>
                        <select class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" required>
                        ...
                        <textarea placeholder="Describe your campaign goals and target audience" rows="4" class="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white resize-none" required></textarea>
                        <button type="submit" class="cta-button w-full py-3 rounded-lg font-semibold text-white">
                            Start Partnership
                        </button>
                    </form>
            ...
            const form = registrationModalBody.querySelector('form');
    ...
    function handleRegistrationSubmit(e) {
        ...
        setTimeout(() => {
            showSuccessMessage('Registration submitted successfully! We will contact you within 24 hours.');
            form.reset();
